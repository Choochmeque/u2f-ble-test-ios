...
final class TransportHelper {
    ...
    static func split(_ data: Data, command: CommandType, chuncksize: Int) -> [Data]? {
        ...
        while remainingLength > 0 {
            ...
            writer.writeNextData((data as NSData).subdata(with: NSRange.init(location: offset, length: length)))
    ...
    static func join(_ chunks: [Data], command: CommandType) -> Data? {
        ...
        for chunk in chunks {
            ...
            if firstChunk {
                ...
                writer.writeNextData((chunk as NSData).subdata(with: NSRange.init(location: 3, length: chunk.count - 3)))
                ...
                writer.writeNextData((chunk as NSData).subdata(with: NSRange.init(location: 1, length: chunk.count - 1)))
